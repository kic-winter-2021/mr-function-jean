...
<header class ="logoheader">
	...
	<!-- 회원가입 타이틀 부분 -->
	<form:form modelAttribute="seller" action="ssignup" method="post" class="id">
	<!-- error binding -->
	...
	<div class="nameInput">
       <h3 class="list">이름</h3>
       <span class="box_name"><form:input path="name" type="text" id="name" class="int_check" maxlength="30" /></span>
    </div>               
	...
	<div class ="row_group">
	 <!-- 상호 입력 -->
       <div class="companynameInput">
          <h3 class="list">상호</h3>
          <span class="box_companyname">
          <form:input path="nickname" type="text" id="nickname" class="int check" maxlength="20" /></span>
       </div>
	</div>
	...
	<div class ="idInput">
		...
		<span class="box_id"><form:input path="id" type ="text" id ="id" placeholder="아이디 입력" class="int check" maxlength="20" /></span>
	</div>
	...
	<div class="pwInput">
		...
		<span class="box_pw"><form:input path="password" type ="password" id ="pw" class="check" maxlength="20" /></span><br>
	</div>
	
	<!-- 비밀번호 재확인 -->
	<div class="pwInputCheck">
		<h3 class="list">비밀번호 재확인</h3>
		<span class="box_pwcheck"><input type ="password" id ="pwCheck" class="int check" maxlength="20"></span><br>
	</div>
		
	<!-- 전화번호 입력 -->
	<div class="phonenoInput">
		<h3 class="list">전화번호</h3>
		<span class="box_name"><form:input path="phoneno" type="text" id="name" class="int_check" maxlength="20" /></span>
	</div>
	...
	<div class="pwInputCheck">
		...
		<form:select path="type" class="box_pwcheck">
			...
			<form:option value="4" label="오프라인" />
		</form:select><br>
	</div>
