...
<body>
	<div class="board-container">
		<div class="board-header">
			<h2>문의 게시판</h2><span>글 수: ${ listcount }</span>
		</div>
		<table class="tb__question">
				...
				<c:if test="${ listcount > 0 }">
					<c:forEach var="question" items="${ questionlist }">
						<tr>
							...
							<td><fmt:formatDate value="${ question.created_at }" pattern="yy-MM-dd HH:mm" />
			...
			<tfoot>
				...
				<tr><!-- 글쓰기 -->
					<td colspan="5" align="right"><a href="write" class="btn-write">글쓰기</a></td>
				</tr>
			</tfoot>
		</table>
		<!-- Pagination -->
