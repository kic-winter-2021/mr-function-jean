...
<body class="w3-light-grey">
	...
	<div class="w3-content fun-grid" style="max-width: 1600px">
		...
		<div class="menubar">
			...
			<ul class="menulist">	
				<li><a href="/seller/myinfo" class="tab">내 정보<span class="rightarrow">〉</span></a></li>
				<li><a href="/seller/manageitem" class="tab">상품관리<span class="rightarrow">〉</span></a></li>
				<li><a href="/seller/promotion" class="tab">프로모션<span class="rightarrow">〉</span></a></li>
				<li><a href="/seller/stats" class="tab">통계<span class="rightarrow">〉</span></a></li>
			</ul>
		</div>
		<!-- Main -->
		<main class="content">
