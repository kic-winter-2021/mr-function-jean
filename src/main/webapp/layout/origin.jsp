  ...
  <div class="w3-row w3-padding w3-border">
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <img src="resources/w3images/girl_hat.jpg" alt="Girl Hat" style="width:100%" class="w3-padding-16">
          ...
          <div class="w3-row w3-margin-bottom" id="demo1" style="display:none">
            <hr>
              <div class="w3-col l2 m3">
                <img src="resources/w3images/avatar_smoke.jpg" style="width:90px;">
              </div>
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <img src="resources/w3images/man_hat.jpg" alt="Men in Hats" style="width:100%" class="w3-padding-16">
          ...
          <div id="demo2" style="display:none">
            <div class="w3-row">
              <hr>
              <div class="w3-col l2 m3">
                <img src="resources/w3images/girl_train.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
            ...
            <div class="w3-row w3-margin-bottom">
              <div class="w3-col l2 m3">
                <img src="resources/w3images/girl.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <img src="resources/w3images/runway.jpg" alt="Runway" style="width:100%" class="w3-padding-16">
          ...
          <div id="demo3" style="display:none">
            ...
            <div class="w3-row w3-margin-bottom">
              <div class="w3-col l2 m3">
                <img src="resources/w3images/girl_mountain.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
            ...
            <div class="w3-row w3-margin-bottom">
              <div class="w3-col l2 m3">
                <img src="resources/w3images/boy.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
            ...
            <div class="w3-row w3-margin-bottom">
              <div class="w3-col l2 m3">
                <img src="resources/w3images/girl_hood.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
    ...
    <div class="w3-col l4">
      ...
      <div class="w3-white w3-margin">
        <img src="resources/w3images/avatar_girl2.jpg" alt="Jane" style="width:100%" class="w3-grayscale">
      ...
      <div class="w3-white w3-margin">
        ...
        <ul class="w3-ul w3-hoverable w3-white">
          <li class="w3-padding-16">
            <img src="resources/w3images/avatar_smoke.jpg" alt="Image" class="w3-left w3-margin-right" style="width:50px">
            <span class="w3-large">Denim</span>
            <br>
            <span>Sed mattis nunc</span>
          </li>
          <li class="w3-padding-16">
            <img src="resources/w3images/bandmember.jpg" alt="Image" class="w3-left w3-margin-right" style="width:50px">
            <span class="w3-large">Sweaters</span>
            <br>
            <span>Praes tinci sed</span>
          </li>
          <li class="w3-padding-16">
            <img src="resources/w3images/workshop.jpg" alt="Image" class="w3-left w3-margin-right" style="width:50px">
            <span class="w3-large">Workshop</span>
            <br>
            <span>Ultricies congue</span>
          </li>
          <li class="w3-padding-16">
            <img src="resources/w3images/avatar_smoke.jpg" alt="Image" class="w3-left w3-margin-right w3-sepia" style="width:50px">
