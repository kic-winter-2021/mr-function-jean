...
<!-- 작성일자 : 21.12.05 09:36pm -->
	...
	내용 : <br><textarea class="field" placeholder="내용을 입력해주세요"></textarea><br>
	판매자 휴대전화 : <input class="box" type="number" placeholder="전화번호를 입력해주세요" ><br>
	판매자 이메일 : <input class="box" type="email" placeholder="이메일을 입력해주세요" ><br>
	첨부파일 : <input class="file" type="file"><br><br>
